...
async function updateAndMeargeMock (projectId, swaggerDocs, caseName) {
  /* istanbul ignore next */
  const { basePath = '/', paths } = swaggerDocs

  const apis = await MockProxy.find({ project: projectId, case: caseName })
...
module.exports = class SwaggerUtil {
  static async create (project) {
    ...
    return createMock(project, docs)
  }
}
